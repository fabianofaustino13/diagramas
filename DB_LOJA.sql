...
CREATE TABLE IF NOT EXISTS TB_SEXOS(
    ...
    SEX_SIGLA CHAR(4) NOT NULL,
    CONSTRAINT PRIMARY KEY(PK_SEX),
    CONSTRAINT UK_SEX_SIGLA UNIQUE KEY(SEX_SIGLA)
);
...
CREATE TABLE IF NOT EXISTS TB_MARCAS(
    ...
    CONSTRAINT UK_MAR_NOME UNIQUE KEY(MAR_NOME)
);
...
=======
VALUES 
>>>>>>> 773b1e1155fc1cb91d81ad994a9653fe2544d106
	('MIKASA'),
    ('MIZUNO'),
    ('NIKE'),
    ('ADIDAS');
...
CREATE TABLE IF NOT EXISTS TB_DEPARTAMENTOS(
    ...
    CONSTRAINT UK_DEP_NOME UNIQUE KEY(DEP_NOME)
);
...
CREATE TABLE IF NOT EXISTS TB_PRODUTOS(
    ...
    FK_PRO_MAR SMALLINT UNSIGNED,
    FK_PRO_DEP SMALLINT UNSIGNED,
...
<<<<<<< HEAD
	PK_MATRICULA INT UNSIGNED NOT NULL AUTO_INCREMENT,
=======
    PK_MATRICULA INT(10) UNSIGNED ZEROFILL NOT NULL,
>>>>>>> 773b1e1155fc1cb91d81ad994a9653fe2544d106
    FUN_NOME VARCHAR(80) NOT NULL,
    FUN_CPF VARCHAR(11) NOT NULL,
    FUN_LOGRADOURO VARCHAR(100),
    FUN_NUMERO VARCHAR(10),
    FUN_COMPLEMENTO VARCHAR(25),
    FUN_DATA_ADMISSAO DATE NOT NULL,
    FUN_DATA_DEMISSAO DATE,
    FK_FUN_SEX TINYINT UNSIGNED NOT NULL,
    FK_FUN_SUP SMALLINT UNSIGNED,
    FK_FUN_CEP VARCHAR(8) NOT NULL,
    CONSTRAINT PRIMARY KEY(PK_MATRICULA),
    CONSTRAINT UNIQUE KEY(FUN_CPF),
    CONSTRAINT FK_SEX_FUN FOREIGN KEY(FK_FUN_SEX) REFERENCES TB_SEXOS(PK_SEX),
	CONSTRAINT FK_CEP_FUN FOREIGN KEY(FK_FUN_CEP) REFERENCES TB_CEPS(PK_CEP)
);
...
INSERT INTO TB_FUNCIONARIOS
	(FUN_NOME, FUN_CPF, PK_MATRICULA, FUN_NUMERO, FUN_DATA_ADMISSAO, FK_FUN_SUP, FK_FUN_SEX, FK_FUN_CEP) 
VALUES 
...
CREATE TABLE IF NOT EXISTS TB_FONE_FUNCIONARIOS(
<<<<<<< HEAD
	FK_FDF_MATRICULA INT UNSIGNED NOT NULL,
    FDF_FONE VARCHAR(12) NOT NULL,
    CONSTRAINT PRIMARY KEY(FK_FDF_MATRICULA, FDF_FONE),
    CONSTRAINT FK_MATRICULA_FDF FOREIGN KEY(FK_FDF_MATRICULA) REFERENCES TB_FUNCIONARIOS(PK_MATRICULA)
);

INSERT INTO TB_FONE_FUNCIONARIOS 
	(FK_FDF_MATRICULA, FDF_FONE) 
=======
	FK_FDF_FUN INT(10) UNSIGNED ZEROFILL NOT NULL,
    FDF_FONE VARCHAR(12) NOT NULL,
    CONSTRAINT PRIMARY KEY(FK_FDF_FUN, FDF_FONE),
    CONSTRAINT FK_FUN_FDF FOREIGN KEY(FK_FDF_FUN) REFERENCES TB_FUNCIONARIOS(PK_MATRICULA)
);
...
<<<<<<< HEAD
    FK_VDS_FUN INT UNSIGNED NOT NULL,
=======
    FK_VDS_FUN INT(10) UNSIGNED ZEROFILL NOT NULL,
>>>>>>> 773b1e1155fc1cb91d81ad994a9653fe2544d106
    CONSTRAINT PRIMARY KEY(PK_VDS),
    CONSTRAINT FK_CLI_VDS FOREIGN KEY(FK_VDS_CLI) REFERENCES TB_CLIENTES(PK_CLI),
    CONSTRAINT FK_FUN_VDS FOREIGN KEY(FK_VDS_FUN) REFERENCES TB_FUNCIONARIOS(PK_MATRICULA)
);

INSERT INTO TB_VENDAS 
	(FK_VDS_CLI, FK_VDS_FUN, VDS_DATA, VDS_NF) 
VALUES 
	(1, 20, 20171001, '456'),
    (2, 30, 20170501, '654'),
    (2, 40, 20180501, '885'),
