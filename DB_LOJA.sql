...
INSERT INTO TB_CLIENTES 
	(CLI_LOGRADOURO, CLI_NUMERO, CLI_COMPLEMENTO, FK_CLI_CEP) 
VALUES
	('', '55', 'NICE 705', '59075770'),
    ('', '', '', '68560000'),
    ('', '', '', '68560000');
...
INSERT INTO TB_VENDEDORES
	(VEN_CPF, VEN_NOME, VEN_MATRICULA, FK_VEN_SUP, FK_VEN_SEX, FK_VEN_CEP) 
VALUES 
	(00000000000, 'JOAOZINHO 30', '0000', 2, 1, '59075040'),
    (11111111111, 'TEREZINHA DE JESUS', '1111', '', 2, '59075040'),
    (22222222222, 'ANA JÚLIA', '2222', 2, 2, '59075040'),
    (33333333333, 'LÉO BATISTA', '3333', 3, 1, '59075050'),
    (44444444444, 'MARIA DE JEUS SANTOS', '4444', 2, 2, '59075060');
...
INSERT INTO TB_VENDAS 
	(FK_VDS_CLI, FK_VDS_VEN, VDS_DATA) 
VALUES 
	(1, 2, 20171001),
    (2, 3, 20170501),
    (3, 4, 20180501),
