...
CREATE TABLE IF NOT EXISTS TB_PAUTAS_OPCOES_RESPOSTAS(
    ...
    CONSTRAINT PRIMARY KEY(FK_POR_ODR, FK_POR_PAU),
    CONSTRAINT FK_POR_ODR FOREIGN KEY(FK_POR_ODR) REFERENCES TB_OPCOES_RESPOSTAS(PK_ODR),
    CONSTRAINT FK_PAU_POR FOREIGN KEY(FK_POR_PAU) REFERENCES TB_PAUTAS(PK_PAU)
);

INSERT INTO TB_PAUTAS_OPCOES_RESPOSTAS 
	(FK_POR_PAU, FK_POR_ODR) 
VALUES 
	(1,1),
    (2,1),
    (3,3),
...
--    FK_ODR_POR TINYINT UNSIGNED NOT NULL,
--    FK_PAU_POR INT UNSIGNED NOT NULL,
--    FK_MOR_POR INT UNSIGNED NOT NULL,
    CONSTRAINT PRIMARY KEY(PK_MOR)
--    CONSTRAINT FK_SIN_MOR FOREIGN KEY(FK_MOR_SIN) REFERENCES TB_MORADORES(PK_MOR)
 --   CONSTRAINT FK_POR_MOR FOREIGN KEY(FK_PAU_POR, FK_ODR_POR) REFERENCES TB_PAUTAS_OPCOES_RESPOSTAS(FK_POR_PAU, FK_POR_ODR)
 --   CONSTRAINT FK_POR_PAU FOREIGN KEY(FK_PAU_POR) REFERENCES TB_PAUTAS_OPCOES_RESPOSTAS(FK_POR_PAU),
 --   CONSTRAINT FK_POR_ODR FOREIGN KEY(FK_ODR_POR) REFERENCES TB_PAUTAS_OPCOES_RESPOSTAS(FK_POR_ODR)
);
