...
INSERT INTO TB_MORADORES 
	(MOR_NOME, MOR_CPF, MOR_LOGIN, MOR_STATUS, FK_MOR_PER) 
VALUES 
    ('CARLA AGUIAR FALCAO', '11111111111', 'CAF', TRUE, 1),
    ('MARIA DA CONCEIÇÃO AGUIAR', '22222222222', 'MCA', FALSE, 2),
    ('GEORGE ANDERSON', '33333333333', 'GA', FALSE, 4),
    ('GEORGE WANDEMOND', '44444444444', 'GW', FALSE, 4);
